...
import { Menu, X, Store, LayoutDashboard, Package, Users, ShoppingCart, Receipt, BarChart3, LogOut } from 'lucide-react';
...
export default function MobileNav() {
  ...
  return (
    <>
      ...
      <div
        className={`fixed top-0 bottom-0 left-0 rtl:left-auto rtl:right-0 z-50 w-64 bg-white dark:bg-slate-900 border-r rtl:border-r-0 rtl:border-l border-slate-200 dark:border-slate-800 transform transition-transform duration-200 ease-in-out lg:hidden ${
